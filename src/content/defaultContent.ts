...
export const defaultContent: LandingContent = {
  ...
  hero: {
    ...
    showcase: {
      ...
      strikeLineColor: "#E33D35",
      note: "1st Batch Disc. +<br>Waiting list Disc.",
      finalPrice: "Rp 171.000",
      finalPriceBg: "#4A72C4",
      finalPriceColor: "#FFFFFF",
      discountBadge: "24% + 10% off",
      discountBadgeBg: "#F4645C",
